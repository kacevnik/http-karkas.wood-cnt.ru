...
$form = array(
	'subject' => 'Отправка Каркас подбор проекта ',
	'heading' => 'Отправка новой формы',
	'success_redirect' => 'thanks11.html',
	'resources' => array(
	...
	'fields' => array(
		'custom_U9652' => array(
			...
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Желаемая площадь\' не может быть пустым.'
			)
		),
		'custom_U9631' => array(
			'order' => 2,
			...
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Фундамент\' не может быть пустым.'
			)
		),
		'custom_U9618' => array(
			'order' => 3,
			...
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Кровля\' не может быть пустым.'
			)
		),
		'custom_U9627' => array(
			'order' => 4,
			...
			'required' => true,
			'errors' => array(
				'required' => 'Поле \'Внешняя отделка\' не может быть пустым.'
			)
		),
		'custom_U9648' => array(
			'order' => 5,
